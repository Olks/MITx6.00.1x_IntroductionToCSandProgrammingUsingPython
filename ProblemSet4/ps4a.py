...
WORDLIST_FILENAME = "C:\\Users\\Olks\\Desktop\\Edx_Python\\ProblemSet4\\6001x\\words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    for letter in letterFreq.keys():
        valid = valid and letterFreq[letter] <= hand.get(letter, 0)
    return valid 
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        elif isValidWord(answer, hand, wordList) == False:
