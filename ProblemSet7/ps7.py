...
class PhraseTrigger(Trigger):
    def __init__(self, phrase):
        self.phrase = phrase
    def evaluate(self, story):
        decision1 = self.phrase in story.getSubject()
        decision2 = self.phrase in story.getTitle()
        decision3 = self.phrase in story.getSummary()
        return decision1 or decision2 or decision3 
